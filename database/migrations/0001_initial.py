    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ipv4', models.CharField(default='No asignado', max_length=50)),
                ('mac', models.CharField(default='No asignado', max_length=50)),
                ('departamento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='database.departamento')),
            ],
        ),
        migrations.CreateModel(
            name='Solvencia',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('tipo', models.CharField(default='No asignado', max_length=50)),
                ('bien_nacional', models.CharField(default='000000', max_length=6)),
